...
function TurdImage(props) {
  if (props.color == "green") {
    return <img src={greenPoop} className="image2"></img>;
  } else if (props.color == "red") {
    return <img src={redPoop} className="image2"></img>;
  } else if (props.color == "brown") {
    return <img src={brownPoop} className="image2"></img>;
  } else if (props.color == "white") {
    return <img src={whitePoop} className="image2"></img>;
  } else if (props.color == "purple") {
    return <img src={purplePoop} className="image2"></img>;
  }
}
